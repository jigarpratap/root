package com.firstapp.demofirstapp;
...
public class Configuration {
  ...
  private static final String CONFIGS_PROPERTY = "com.firstapp.demofirstapp.configs";
  ...
  private void postConstruct() {
    try{
      ...
      logger.error("demofirstapp-backend failed to deploy", e);
